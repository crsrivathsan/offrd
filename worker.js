...
async function handleSearch(request, env, ip) {
  ...
  // sent here — anything beyond that needs num_pages (more pages, each
  // with its own request cost), not a bigger num.
  const num      = Math.min(parseInt(params.get('num') || '10'), 10);
