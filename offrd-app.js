...
const S = {
  ...
  // per search" means: if the person re-runs the exact same
  // keywords+location+boards+country, we resume where they left off;
  // if any of those change, it's a different search and starts at 1.
